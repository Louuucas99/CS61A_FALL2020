...
class Card:
    ...
    def power(self, other_card):
        ...
        return power  #这里不能用self.power,不知道为什么
...
class TutorCard(Card):
    ...
    def effect(self, other_card, player, opponent):
        ...
        opponent.hand += [opponent.deck.draw() for i in range(3)]
...
class TACard(Card):
    ...
    def effect(self, other_card, player, opponent):
        ...
        """
        "*** YOUR CODE HERE ***"
        mid = other_card.defense
        other_card.defense = other_card.attack
        other_card.attack = mid
